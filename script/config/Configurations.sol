...
contract Configurations is Constants {
    ...
    function _prepareModeConfigs() internal {
        ...
        mode1Tokens[2] = USDT;
        mode1Tokens[3] = WMNT;
        mode1Tokens[4] = USDY; // NOTE: usdy has no oracle yet, add to see if it works on deposit/withdraw
        uint128[] memory mode1CollateralFactors = new uint128[](5);
        mode1CollateralFactors[0] = 909e15; // WETH 0.909
        mode1CollateralFactors[1] = 909e15; // WBTC 0.909
        mode1CollateralFactors[2] = 952e15; // USDT: 0.952
        mode1CollateralFactors[3] = 869e15; // WMNT: 0.869
        mode1CollateralFactors[4] = 952e15; // USDY: 0.952
        uint128[] memory mode1BorrowFactors = new uint128[](5);
        mode1BorrowFactors[0] = 11e17; // WETH: 1.1
        mode1BorrowFactors[1] = 11e17; // WBTC: 1.1
        mode1BorrowFactors[2] = 105e16; // USDT: 1.05
        mode1BorrowFactors[3] = 115e16; // WMNT: 1.15
        mode1BorrowFactors[4] = 105e16; // USDY: 1.05
        uint128[] memory debtCeilings1 = new uint128[](5);
        debtCeilings1[0] = 800e18;
        debtCeilings1[1] = 80e8;
        debtCeilings1[2] = 800_000e18;
        debtCeilings1[3] = 1_000_000e18;
        debtCeilings1[4] = 0;
        ...
        mode2CollateralFactors[0] = 952e15; // WETH 0.952
        mode2CollateralFactors[1] = 926e15; // WBTC 0.926
        mode2CollateralFactors[2] = 909e15; // WMNT: 0.909
        uint128[] memory mode2BorrowFactors = new uint128[](3);
        mode2BorrowFactors[0] = 11e17; // WETH: 1.1
        mode2BorrowFactors[1] = 11e17; // WBTC: 1.1
        mode2BorrowFactors[2] = 115e16; // WMNT: 1.15
        uint128[] memory debtCeilings2 = new uint128[](3);
        debtCeilings2[0] = 400e18;
        debtCeilings2[1] = 40e8;
        debtCeilings2[2] = 500_000e18;
        ...
        // Mode3 lp
        address[] memory mode3Tokens = new address[](3);
        mode3Tokens[0] = WETH_USDT_UNI_V2;
        mode3Tokens[1] = USDT;
        mode3Tokens[2] = WETH;
        uint128[] memory mode3CollateralFactors = new uint128[](3);
        mode3CollateralFactors[0] = 909e15; // WETH_USDT_UNI_V2 0.909
        mode3CollateralFactors[1] = 952e15; // USDT: 0.952
        mode3CollateralFactors[2] = 909e15; // WETH: 0.909
        uint128[] memory mode3BorrowFactors = new uint128[](3);
        mode3BorrowFactors[0] = 11e17; // WETH_USDT_UNI_V2: 1.1
        mode3BorrowFactors[1] = 11e17; // WETH: 1.1
        mode3BorrowFactors[2] = 105e16; // USDT: 1.05
        uint128[] memory debtCeilings3 = new uint128[](3);
    ...
    function _prepareOracleConfigs() internal {
        ...
        oracleConfig.api3DataFeedIds[0] = BTC_DATA_FEED_ID;
        oracleConfig.api3MaxStaleTimes[0] = type(uint).max;
        oracleConfig.pythPriceFeedIds[0] = BTC_PRICE_FEED_ID;
