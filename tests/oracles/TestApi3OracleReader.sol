...
contract TestApi3OracleReader is Test {
    ...
    bytes32 public constant BTC_DATAFEED_ID_ARBITRUM =
    ...
    function testSetDataFeedIdNotMatchLength() public {
        ...
        dataFeeds[0] = BTC_DATAFEED_ID_ARBITRUM;
        dataFeeds[1] = BTC_DATAFEED_ID_ARBITRUM;

        vm.expectRevert('INC#200'); // ARRAY_LENGTH_MISMATCHED
    ...
    function testDataFeedIdNotSet() public {
        vm.expectRevert('INC#705'); // DATAFEED_ID_NOT_SET
    ...
    function testMaxTimeStaleNotSet() public {
        ...
        vm.expectRevert('INC#706'); // MAX_STALETIME_NOT_SET
        api3OracleReader.getPrice_e36(WBTC_ARBITRUM);
    }
    ...
    function testMaxStaleTimeExceeded() public {
        ...
        vm.expectRevert('INC#707'); // MAX_STALETIME_EXCEEDED
        api3OracleReader.getPrice_e36(WBTC_ARBITRUM);
    }
}
