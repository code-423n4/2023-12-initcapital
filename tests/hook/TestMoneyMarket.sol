...
contract TestMoneyMarket is DeployAll {
    ...
    function testDepositAndBorrowSimple() public {
        _createBorrowAndDeposit(ALICE, WETH, 10_000, USDT, 2_000);
    }

    function testRepay() public {
        (uint posId, uint initPosId) = _createBorrowAndDeposit(ALICE, WETH, 10_000, USDT, 2_000);
    ...
    function testChangeCollateral() public {
        (uint posId, uint initPosId) = _createBorrowAndDeposit(ALICE, WETH, 10_000, WBTC, 2_000);
