...
contract TestConfig is DeployAll {
    function testSetModeConfig() public {
        ...
        mode100CollPools[0] = address(lendingPools[WETH]);
        mode100CollPools[1] = address(lendingPools[WBTC]);
        mode100CollPools[2] = address(lendingPools[USDT]);
        uint128[] memory mode100CollFactors = new uint128[](3);
        mode100CollFactors[0] = 909e15; // WETH 0.909
        mode100CollFactors[1] = 909e15; // WBTC 0.909
        mode100CollFactors[2] = 952e15; // USDT: 0.952
        ...
        (address[] memory collPools, address[] memory borrPools, uint maxHealthAfterLiq_e18) = config.getModeConfig(100);
