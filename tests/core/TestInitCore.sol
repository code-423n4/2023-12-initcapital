...
contract TestInitCore is DeployAll {
    ...
    function testMintExcessSupplyCapRevert() public {
        ...
        // mint pool
        // experctRevert SUPPLY_CAP_REACHED(INC#406)
        deal(WETH, ALICE, 2e18);
        _mintPool(ALICE, poolAddress, 2e18, bytes('INC#406'));
    }
    ...
    function testCreatePos() public {
        ...
        // expect revert ALREADY_SET (INC#106)
        vm.expectRevert('INC#106');
    ...
    function testCollateralPositionWithUnsupportedTokenRevert(uint _amount) public {
        ...
        // collateralize
        // expectRevert  INVALID_MODE(INC#500)
        deal(USDT, ALICE, _amount);
        _collateralizePosition(ALICE, posId, address(lendingPools[USDT]), _amount, bytes('INC#500'));
    }
    ...
    function testBorrowExcessModeDebtCeilingRevert() public {
        ...
        // borrow
        // expectRevert DEBT_CEILING_EXCEEDED (INC#800)
        _borrow(ALICE, posId, poolWETH, debtCeiling + 1, bytes('INC#800'));
    }
    ...
    function testBorrowExcessPoolBorrowCapRevert() public {
        ...
        // borrow
        // expectRevert BORROW_CAP_REACHED(INC#407)
        _borrow(ALICE, posId, poolWETH, borrAmts, bytes('INC#407'));
    }
    ...
    function testDecollateralizeUnhealthyPositionRevert() public {
        ...
        _decollateralizePosition(ALICE, posId, poolWBTC, actualCollAmt, bytes('INC#300'));
    }
    ...
    function testBorrowUnhealthyPositionRevert() public {
        ...
        _borrow(ALICE, posId, poolWETH, borrAmt, bytes('INC#300'));
    }
    ...
    function testLiquidateHealthyPositionRevert() public {
        ...
        // expect revert POSITION_HEALTHY(INC#303)
        _liquidate(BOB, posId, debtShares / 3, poolWBTC, poolUSDT, false, bytes('INC#303'));
    }
    ...
    function testLiquidatePositionInvalidOutputToken() public {
        ...
        // expect revert ZERO_VALUE (no share collaterals)
        _liquidate(BOB, posId, debtShares / 3, poolWBTC, poolWMNT, false, bytes('INC#100'));
    }
    ...
    function testChangeModeRevert() public {
        ...
        // expectRevert INVALID_MODE(INC#500)
        _changeMode(ALICE, pos, 2, bytes('INC#500'));
    }
    ...
    function testChangeModeBorrowCapRevert() public {
        ...
        // expectRevert DEBT_CEILING_EXCEEDED(INC#800)
        _changeMode(ALICE, pos, 2, bytes('INC#800'));
    }
    ...
    function testChangeModeHealthRevert() public {
        ...
        // change mode
        // expectRevert POSITION_NOT_HEALTHY(INC#300)
        _changeMode(ALICE, pos, 1, bytes('INC#300'));
    }
    ...
    function testAddTooManyCollaterals() public {
        ...
        // expected revert MAX_COLL_COUNT (INC#602)
        _collateralizePosition(ALICE, posId, poolUSDT, 1e18, bytes('INC#602'));
    }
    ...
    function _liquidate(
        ...
        if (isUnderwater) {
            ...
            assertLt(posAfter.health, posBefore.health);
        } else {
