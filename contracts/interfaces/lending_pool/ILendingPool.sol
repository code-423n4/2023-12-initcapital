...
interface ILendingPool {
    ...
    /// @notice interest needs to be accrued before sync cash
    /// @notice only core can call this function
    /// @dev sync the current cash record
    /// @return newCash the new cash amount
    function syncCash() external returns (uint newCash);
